...
function Footer() {
    ...
    document
      ...
      .forEach((el) => {
        ...
        el.addEventListener("mouseout", () => {
          handleDispatch("CURSOR_STYLES", "footerMouse");
        });
      });
  }, []);
  ...
  return (
    <footer
      ...
      data-scroll-section
      onMouseEnter={() =>
        dispatch({ type: "CURSOR_STYLES", cursorStyles: "footerMouse" })
      }
      onMouseLeave={() =>
    ...
    >
      <div className={styles.mainFooter}>
        ...
        <div className={styles.sayHello} data-scroll>
          <a
            href="mailto:nivedinp@gmail.com"
            onMouseEnter={() =>
              dispatch({ type: "CURSOR_STYLES", cursorStyles: "footerHello" })
            }
            onMouseLeave={() =>
              dispatch({ type: "CURSOR_STYLES", cursorStyles: "footerMouse" })
            }
      ...
      <div className={styles.footerLinks}>
        <div className={styles.footerLinksContainer}>
          <a href="https://linkedin.com/in/nivedinp">
            <span>
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <a href="https://www.instagram.com/nivedin">
            <span>
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <a href="https://github.com/nivedin">
            <span>
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <a href="https://dribbble.com/nivedin">
            <span>
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <a href="https://www.behance.net/nivedin">
            <span>
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <a
            href="/Nivedin.P.Suryan-Resume.pdf"
            download
            target="_blank"
            title="Resume"
          >
